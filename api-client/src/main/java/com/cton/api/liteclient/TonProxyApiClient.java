// TonProxyApiClient.java - реалізація клієнта для проксі-сервера TON
// Author: Андрій Будильников (Sparky)
// Implementation of client for TON proxy server
// Реализация клиента для прокси-сервера TON
...
/**
 * Реалізація клієнта для з'єднання з проксі-сервером TON
 * 
 * Implementation of client for connecting to TON proxy server
 * Реализация клиента для соединения с прокси-сервером TON
 */
public class TonProxyApiClient implements LiteClient {
    ...
    public JsonObject runGetMethod(String address, String method, JsonObject stack) throws IOException {
        if (!connected) {
            throw new IOException("Not connected to proxy server");
        }
