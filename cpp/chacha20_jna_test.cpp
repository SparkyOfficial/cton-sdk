// chacha20_jna_test.cpp - Test ChaCha20 functionality mimicking JNA calls
...
int main() {
    std::cout << "Testing ChaCha20 functionality mimicking JNA calls..." << std::endl;
    ...
    try {
        ...
        // Now decrypt by calling the native function again
