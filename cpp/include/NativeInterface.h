// NativeInterface.h - C-стильний інтерфейс для JNA
// Author: Андрій Будильников (Sparky)
// C-style interface for JNA bindings
// C-стильный интерфейс для JNA биндингов

#ifndef CTON_NATIVE_INTERFACE_H
#define CTON_NATIVE_INTERFACE_H
