// chacha20_simple_test.cpp - Simple test for ChaCha20 encryption
...
int main() {
    std::cout << "Testing ChaCha20 encryption directly..." << std::endl;
    ...
    try {
        ...
        // Encrypt using ChaCha20 directly
        ...
        // Decrypt using ChaCha20 directly
