...
.def	ossl_rsaz_amm52x30_x1_avxifma256;	.scl 2;	.type 32;	.endef
.p2align	5
ossl_rsaz_amm52x30_x1_avxifma256:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ossl_rsaz_amm52x30_x1_avxifma256:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.LSEH_end_ossl_rsaz_amm52x30_x1_avxifma256:
.section	.rodata
.p2align	5
.Lmask52x4:
...
.def	ossl_rsaz_amm52x30_x2_avxifma256;	.scl 2;	.type 32;	.endef
.p2align	5
ossl_rsaz_amm52x30_x2_avxifma256:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_ossl_rsaz_amm52x30_x2_avxifma256:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
	movq	%r9,%rcx
...
.LSEH_end_ossl_rsaz_amm52x30_x2_avxifma256:
.text	

.p2align	5
.globl	ossl_extract_multiplier_2x30_win5_avx
.def	ossl_extract_multiplier_2x30_win5_avx;	.scl 2;	.type 32;	.endef
