...
.def	sha512_block_data_order_sha512ext;	.scl 3;	.type 32;	.endef
.p2align	6
sha512_block_data_order_sha512ext:
	movq	%rdi,8(%rsp)
	movq	%rsi,16(%rsp)
	movq	%rsp,%rax
.LSEH_begin_sha512_block_data_order_sha512ext:
	movq	%rcx,%rdi
	movq	%rdx,%rsi
	movq	%r8,%rdx
...
.Lsha512ext_shortcut:
	...
	vmovdqu	%xmm8,32(%rsp)
	vmovdqu	%xmm9,48(%rsp)
	vmovdqu	%xmm11,64(%rsp)
	vmovdqu	%xmm12,80(%rsp)
	vmovdqu	%xmm13,96(%rsp)
	vmovdqu	%xmm14,112(%rsp)
	vmovdqu	%xmm15,128(%rsp)
...
.byte	0xc4,0x62,0x1f,0xcb,0xd8
	...
	vmovdqu	80(%rsp),%xmm12
	vmovdqu	96(%rsp),%xmm13
	vmovdqu	112(%rsp),%xmm14
	vmovdqu	128(%rsp),%xmm15
	addq	$144,%rsp
...
.LSEH_end_sha512_block_data_order_sha512ext:
