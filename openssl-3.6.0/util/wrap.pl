...
BEGIN {
    ...
    require '/c/Users/Богдан/Desktop/cton-sdk/openssl-3.6.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/c/Users/Богдан/Desktop/cton-sdk/openssl-3.6.0/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/c/Users/Богдан/Desktop/cton-sdk/openssl-3.6.0/test/default-and-jitter.cnf';
    shift;
